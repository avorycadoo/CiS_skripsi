                    ...
                    @foreach ($discounts as $discount)
                        <div class="d-flex align-items-center mb-2">
                            <input class="form-check-input me-2" type="checkbox" name="discounts[]" value="{{ $discount->id }}"
                                ...
                                data-original-state="{{ $discount->statusActive ? '1' : '0' }}"
                                data-config-type="discount"
                                data-config-name="{{ $discount->name }}"
                    ...
                    @foreach ($shippings as $shipping)
                        <div class="d-flex align-items-center mb-2">
                            <input class="form-check-input me-2" type="checkbox" name="shippings[]"
                                ...
                                data-original-state="{{ $shipping->statusActive ? '1' : '0' }}"
                                data-config-type="shipping"
                    ...
                    @foreach ($cogs as $cogs_method)
                        <div class="d-flex align-items-center mb-2">
                            <input class="form-check-input me-2" type="checkbox" name="cogs[]"
                                ...
                                data-original-state="{{ $cogs_method->statusActive ? '1' : '0' }}"
                                data-config-type="COGS"
